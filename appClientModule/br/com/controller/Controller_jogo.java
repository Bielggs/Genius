...
public class Controller_jogo {
	...
	public void Escolher_nivel(int nivel) {
		...
		switch (nivel) {
		case 1:
			partida_1 = new Partida(0,0,25, 300, 500, 500);			
			break;
		case 2:
			partida_1 = new Partida(0,0,50, 200, 400, 400);
			
			break;
		case 3:
			partida_1 = new Partida(0,0,100, 150, 300, 380);
			break;
		case 4:
			partida_1 = new Partida(0,0,100, 90, 100, 100);
			break;
		default:
			break;
		}
	...
	public void Adicionar_numero_array_Novo( ) {
		...
		if(partida_1.getSequencia_string() ==null) {
			partida_1.setSequencia_string(String.valueOf(num));
			System.out.println(partida_1.getSequencia_string());
			Converter_Em_Array(partida_1.getSequencia_string());
			
		}else {
			
			partida_1.setSequencia_string(partida_1.getSequencia_string()+";"+String.valueOf(num));
			System.out.println(partida_1.getSequencia_string());
			Converter_Em_Array(partida_1.getSequencia_string());
				
		}
		//partida_1.getSequencia_computador()[partida_1.getTamanho_Array()]= num +""; 
		//rand.nextInt(4) + "";
	...
	public void Converter_Em_Array(String linha) {
		String[] aux = linha.split(";");
		//partida_1.getSequencia_computador() = null;
		partida_1.setSequencia_computador(aux);
	}
	
	public int Jogada(String jogada) {
		//partida_1.setSequencia_string(partida_1.getSequencia_string()+";"+jogada);
		//Converter_Em_Array(partida_1.getSequencia_string());
	...
	public String Dica() {
		return partida_1.getSequencia_computador()[partida_1.getTamanho_Array()];
	}
